...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.SurahViewHolder> {
    ...
    public SurahViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SurahViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.surah_layout, parent, false),surahListener);
    }
    ...
    public class SurahViewHolder extends RecyclerView.ViewHolder {
        ...
        public SurahViewHolder(@NonNull View itemView, SurahListener surahListener) {
            super(itemView);
